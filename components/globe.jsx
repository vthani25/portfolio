...
export function Globe({ globeConfig, data }) {
  ...
  const startAnimation = () => {
    ...
    globeRef.current
      .arcsData(data)
      .arcStartLat((d) => (typeof d.startLat === 'number' ? d.startLat : 0))
      .arcStartLng((d) => (typeof d.startLng === 'number' ? d.startLng : 0))
      .arcEndLat((d) => (typeof d.endLat === 'number' ? d.endLat : 0))
      .arcEndLng((d) => (typeof d.endLng === 'number' ? d.endLng : 0))
      .arcColor((e) => (typeof e.color === 'string' ? e.color : '#ffffff'))
      .arcAltitude((e) => (typeof e.arcAlt === 'number' ? e.arcAlt : 0.1))
    ...
    globeRef.current
      .ringsData([])
      .ringColor((e) => (t) => (typeof e.color === 'function' ? e.color(t) : '#ffffff'))
